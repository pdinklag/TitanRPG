...
defaultproperties
{
	...
	CostAddPerLevel=5
	MaxLevel=6
	ForbiddenAbilities(0)=(AbilityClass=class'Ability_AdrenalineSurge',Level=1)
	RequiredAbilities(0)=(AbilityClass=class'Ability_Regen',Level=1)
	RequiredAbilities(1)=(AbilityClass=class'Ability_Vampire',Level=1)
	RequiredAbilities(2)=(AbilityClass=class'Ability_AmmoRegen',Level=1)
