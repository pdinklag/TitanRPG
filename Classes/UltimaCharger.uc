class UltimaCharger extends BlastCharger;
...
defaultproperties
{
	...
	ChargeEmitterClass=class'TitanUltimaChargeEmitter'
	ExplosionClass=class'TitanUltimaExplosion'
	
	//As a reference, the original DruidsRPG emitters (you can set them in the INIs):
	//DamageType=class'DamTypeUltima'
	//ChargeEmitterClass=class'UltimaChargeEmitter'
	//ExplosionClass=class'UltimaExplosion'
}
