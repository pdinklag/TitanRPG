class ArtifactVehicleHack extends RPGDelayedUseArtifact;
...
defaultproperties
{
	...
	RedOverlay=Material'<? echo($packageName); ?>.Overlays.VHackRed'
	BlueOverlay=Material'<? echo($packageName); ?>.Overlays.VHackBlue'
	GreenOverlay=Material'<? echo($packageName); ?>.Overlays.VHackGreen'
	GoldOverlay=Material'<? echo($packageName); ?>.Overlays.VHackGold'
	MaxRadius=512.000000
	MaxRunningRadius=512.000000
	CostPerSec=10
	MinActivationTime=5.000000
	IconMaterial=Texture'<? echo($packageName); ?>.ArtifactIcons.VehicleHack'
